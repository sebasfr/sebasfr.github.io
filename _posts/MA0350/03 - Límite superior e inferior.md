...
\end{aligned}
$$
Como $b_{n+1}\leq b_{n}$, note que, por [[Sucesiones#Teorema (Convergencia monótona)|teorema de convergencia monótona]],
$$
...
Sea $\{x_{n}\}_{n=1}^\infty$ una sucesión acotada. y $\{x_{n}\}_{n=1}^\infty$ una [[Subsucesiones |subsucesión]] $\{x_{k_{n}}\}_{n=1}^\infty$ que converge a $L.$Entonces $\liminf x_{n} \leq L \leq \limsup x_{n}$.
