...
slug: 08-aplicaciones-de-la-integral-de-riemann
toc:
  sidebar: right
lang: es
fecha: 2025-05-27
...
{% raw %}
En estas notas se presentan aplicaciones de la integral de Riemann
## Área bajo la curva
...
#### Ejemplo 
Hallar el área entre las curvas $$f(x) = x^{3}, g(x) = 2x$$, $$h(x) = x$$ para $$0 \leq x \leq \sqrt{ 2 }$$.![Pasted image 20250527144810](/assets/img/courses/ma0350/Pasted%20image%2020250527144810.png)Considere la solución de $$x^{3} = x \iff x=\pm 1   \lor   x=0$$. Luego, el área viene dada por, 
